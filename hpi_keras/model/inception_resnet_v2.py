...
def inception_resnet_block(x, scale, block_type, block_idx, activation='relu'):
    ...
    # expand channel of residual path to orignal input node size
    up = conv2d_bn(mixed,
...
def InceptionResNetV2(input_shape=None,
    ...
    # average pool brange ,no downsample
    ...
    if not trainable:
        for i in range(2, len(model.layers)-3):
            model.layers[i].trainable = False
            
    return model

if __name__ == "__main__":
    model = InceptionResNetV2(input_shape=(299, 299, 3), trainable=False)
